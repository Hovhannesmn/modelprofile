...
<div class="new-product">
    ...
    <div class="mens-toolbar">
        ...
        <ul class="women_pagenation">
            ...
            <li><a href="http://www.shopsite.dev/subcat/1?page=1">1</a></li>
            <li><a href="http://www.shopsite.dev/subcat/1?page=2">2</a></li>
            <li ><a href="http://www.shopsite.dev/subcat/1?page=2">3</a></li>
        </ul>
